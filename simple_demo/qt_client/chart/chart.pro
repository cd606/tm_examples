...
LIBS += $${VCPKGDIR}\lib\abseil_dll.lib $${VCPKGDIR}\lib\absl_cord_internal.lib $${VCPKGDIR}\lib\absl_cordz_functions.lib $${VCPKGDIR}\lib\absl_cordz_handle.lib $${VCPKGDIR}\lib\absl_cordz_info.lib $${VCPKGDIR}\lib\absl_cordz_sample_token.lib $${VCPKGDIR}\lib\absl_flags.lib $${VCPKGDIR}\lib\absl_flags_commandlineflag.lib $${VCPKGDIR}\lib\absl_flags_commandlineflag_internal.lib $${VCPKGDIR}\lib\absl_flags_config.lib $${VCPKGDIR}\lib\absl_flags_internal.lib $${VCPKGDIR}\lib\absl_flags_marshalling.lib $${VCPKGDIR}\lib\absl_flags_parse.lib $${VCPKGDIR}\lib\absl_flags_private_handle_accessor.lib $${VCPKGDIR}\lib\absl_flags_program_name.lib $${VCPKGDIR}\lib\absl_flags_reflection.lib $${VCPKGDIR}\lib\absl_flags_usage.lib $${VCPKGDIR}\lib\absl_flags_usage_internal.lib $${VCPKGDIR}\lib\absl_low_level_hash.lib $${VCPKGDIR}\lib\absl_random_internal_distribution_test_util.lib $${VCPKGDIR}\lib\absl_statusor.lib $${VCPKGDIR}\lib\absl_strerror.lib
